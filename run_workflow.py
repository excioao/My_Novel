...
def _gen_fix_instruction(violation: str, result: AuditResult) -> str:
    ...
    if "一刀切" in v and ("不是" in v or "是" in v):
        return "防御性对比句式——一刀切封杀：全文搜索'不是……而是……''不是……是……''是……不是……'（含句号/破折号/逗号变体）。每处重构：直接给物理事实，不需要先否定一个再肯定一个，也不需要先肯定一个再否定一个。改写为：直接观察→直接感受。"
    if "时代错位" in v:
...
def main():
    asyncio.run(main_loop([
        "第2章——北镇抚司暗桩。沈节在地下三层受训：老暗桩木棍钝击教挨打时心脏别停、石室抄暗语模板学识字、档案库挂牌获代号。砖墙渗水结冰，杨木柱前任汗碱凹痕，榆木桌面一道反复刻出的竖痕。章末走到地面，京城雪落。",
        "第3章——碎铁入体。辽东卫所。沈节当夜不收后援撞上异族伏击，破甲箭穿透护心镜箭头碎在心包膜外侧。军医不敢开胸，糊金创药让瘢痕把铁裹死。不能纵马狂奔——心率一快铁就往主动脉推。",
        "第4章——纸上与法上。百户带沈节查抄通敌商人。抄出白银六百两百户私吞三百两上报无所获。商人小女儿蹲院角鞋底磨穿露冻红脚趾。沈节回程记在心里不写纸上——第一课。",
        "第5章——最后一夜。出发大帅府前夜。百户在北镇抚司后门塞给他叠四折麻纸——前三个暗桩代号和死因没一个活过半年。沈节油灯下记住嚼烂吐进炭盆。次日骑马往北。",
        "第6章——十息。沈节抵达大帅府军机书房。主母顾韫隔桌看了他十息——灯捻烧焦半截没人拨。开口第一句：你在锦衣卫的代号是什么。不等回答把他档案秘密全背出：从今天起你是大帅府军机文书。",
        "第7章——阵亡录。主母把辽东阵亡名录放沈节面前他认识上面三个人。她说：你在辽东待过档案上不是这一条——潜伏暴露。抽走名录换药方第一味砒霜——不是杀他是控制他，七日一周期。",
        "第8章——第一碗药。主母亲自端来第一碗药，粗瓷碗口裂痕嵌着前任深褐色药渍。药入喉——从喉咙往心脏蔓延的冷。李观照出现在门口端第二碗，碗比主母小一圈。以后每天早上小姐来送。",
        "第9章——末梢的冷。药效逐层展开——指尖往手腕冷指甲下肉从粉红变灰紫。手放账册封面纸比手温高。油灯下翻看走私流水数额大到不该知道。走廊里主母对李观照说以后每天同样时辰。李观照没回答端空碗站走廊里。",
        "第10章——活死人。正厅三十七个干儿子围三排。沈节站主母身后一步手里空白账册。李国勇：你的脑袋比我们粗人金贵——不是夸奖是定价。沈节翻开空白账册写第一笔。",
    ]))
