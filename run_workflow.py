...
def main():
    asyncio.run(main_loop([
        "第7章——阵亡录。主母把辽东阵亡名录放在沈节面前，他认识上面三个人——同营老兵、帮他换过药军医、还有一个认出了死亡日期。主母手指按在其中一个名字上，指甲盖住头两个字只露出死因。她说：'你在辽东待过。档案上不是这一条。'潜伏暴露。她抽走名录换了一份药方——第一味砒霜。'你识字，自己看。'不是杀他的药，是控制他的——七日一周期，停药第四天起身体崩溃。药方末端缺了一味——缺的那味在李观照手里。",

        "第8章——第一碗药。主母亲自端来第一碗药。粗瓷碗口有一道裂痕嵌着深褐色药渍——前任留下的。她把碗放在他面前，坐在对面等他自己端起来喝。药凉了表面结半透明药膜。沈节端起来喝——苦涩从喉咙往心脏蔓延的冷。李观照出现在书房门口，手里端着第二碗药，碗比主母的小了一圈。主母：'以后每天早上，小姐来送。'李观照的表情是看懂了但不说的人的平静。",

        "第9章——末梢的冷。药效逐层展开——指尖往手腕冷，指甲下肉从粉红变灰紫。手放账册封面上纸比手温高。他在油灯下翻看走私账册流水——数额大到他不该知道。冷一层一层剥开，他不知道会持续多久，只知道每隔七天那碗药会把冷压回去。门没关紧——走廊里主母对李观照说'以后每天早上同样的时辰'。李观照没回答，端着空碗站在走廊里，隔着门缝看碗底残渣——不是在数残渣，是在数他还能活几个七天。",

        "第10章——活死人。正厅。三十七个干儿子围了三排，大帅没来，主母主持。沈节站在主母身后一步，手里只有一本空白账册。榆木柱被火把熏了二十年黑得发亮，夯土地面被靴子踩出凹痕。干儿子按入府年份从内向外排成精确半圆——距主母最近的是李国勇。主母宣布'沈休言掌管全部军机文书与走私账目'。李国勇：'你的脑袋比我们粗人金贵。'沈节翻开空白账册写第一笔——不是一，是还没决定第二笔往哪走的横。",
    ]))
