...
def main():
    asyncio.run(main_loop([
        "第1章——陕甘万人坑。崇祯十三年，渭河河床干涸见底，一个没有名字的狗娃在腐尸堆里翻找发霉的干粮，用手指在河床泥浆里刨水，指甲翻裂。锦衣卫北镇抚司的一个百户路过流民营，停在他面前，问他怕不怕死。他说怕，但更怕饿。百户把他领走了。",
        "第2章——北镇抚司暗桩训练。狗娃被赋予代号和基本身份档案。他学会识字足以读懂公文和暗语，跟踪与反跟踪，在训练中被老暗桩打断三根肋骨后学会打架不是拼力气是拼谁能多撑一口气。百日训练结束，档案标签：无名暗桩，耗材，无家世无派系。",
        "第3章——辽东夜不收侦察任务。一枚异族破甲箭穿透护心镜，倒钩箭头碎在心包膜外侧。军医不敢开胸取箭，用金创药糊住伤口，让瘢痕组织把碎铁裹死在血肉里。从此他成了半个废人，不能纵马狂奔，不能与人搏命，稍微心率加快那枚碎铁片就在胸腔里隐隐往主动脉方向推。",
        "第4章——锦衣卫内部腐败。百户带他去查抄一个通敌商人家，抄出白银六百两，百户私吞三百两，上报兵部无所获。回程路上沈节把这事记在心里，不写在纸上。这是他学的第一课：纸上的东西和法律上的东西是两回事。",
        "第5章——出发前夜。上线百户把他叫到暗室，把潜伏指令塞进他手心，一张叠了四折的麻纸，拍他肩膀说这趟回来给你补一个正式编制。沈节在油灯下看完记住了每一行，然后把纸放进嘴里嚼烂吐进炭盆。百户看着他说你是真的怕死。他说我是真的不想白死。第二天早晨，他骑上马，往北，大帅府方向。",
    ]))
