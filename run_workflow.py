...
def main():
    asyncio.run(main_loop([
        "第2章——北镇抚司暗桩。沈节（狗娃）在北镇抚司地下三层受训：老暗桩用裹麻布短木棍教他挨打时心脏别停、石室抄写暗语模板学识字、档案库挂牌获代号'沈节'。砖墙渗水结冰，杨木柱有前任汗碱凹痕，榆木桌面一道被反复刻出的竖痕，松木架上无名暗桩木牌灰尘厚度不一。他用默数几息恢复来量心跳变化。章末走到地面，京城雪落下来。",

        "第3章——碎铁入体。沈节在辽东充当夜不收后援，撞上异族伏击。破甲箭穿透护心镜，箭头碎在心包膜外侧。军医不敢开胸，金创药敷上去，碎铁片永远留在体内。第一次感觉到它——不是痛，是胸腔里多了个不属于自己的东西。档案备注改为'身有宿疾，不宜外勤'。",

        "第4章——纸上与法上。百户带沈节查抄'通敌'商人。抄出白银六百两，百户私吞三百两，上报'无所获'。商人小女儿蹲在院角，鞋底磨穿，露出一截冻红的脚趾。沈节在回程路上把这事记在心里——不写在纸上。第一课：纸上的东西和法律上的东西是两回事。",

        "第5章——最后一夜。出发大帅府前夜。百户在北镇抚司后门塞给他一张叠了四折的麻纸——前三个暗桩的代号和死因，没一个活过半年。沈节在油灯下记住，嚼烂，吐进炭盆。百户：'你是真的怕死。'沈节：'我是真的不想白死。'纸灰在低温中冷却。次日骑马往北。",

        "第6章——十息。沈节抵达大帅府，军机书房等候。主母顾韫隔桌看了他十息。灯捻烧焦半截没人拨。她开口第一句：'你在锦衣卫的代号是什么。'然后不等回答，把他档案上的秘密全部背了出来。最后说：'从今天起，你是大帅府的军机文书。'",

        "第7章——阵亡录。主母把辽东阵亡名录放在沈节面前，他认识上面三个人。主母：'你在辽东待过。档案上不是这一条。'他的潜伏暴露了。她抽走名录，换了一份药方——第一味：砒霜。她说：'你识字，自己看。'不是杀他的药。是控制他的——七日一周期。",

        "第8章——第一碗药。主母亲自端来第一碗药，坐在对面等他自己喝。粗瓷碗口有一道裂痕，嵌着前任留下的深褐色药渍。药入喉——冷，从食道往心脏方向蔓延。李观照出现在门口，端着第二碗。主母：'以后每天早上，小姐来送。'",

        "第9章——末梢的冷。药效逐层展开——指尖往手腕冷，脚尖往脚踝冷。手放在账册封面上，纸比手温高。他在油灯下翻看张家口马市私市流水，数额大到他不该知道。走廊里主母对李观照说：'以后每天早上，同样的时辰。'李观照没回答，端着空碗站在走廊里。",

        "第10章——活死人。主母当众宣布沈休言掌管全部军机文书与走私账目。三十七个干儿子围了三排。李国勇：'你的脑袋比我们粗人金贵。'不是夸奖，是定价。沈节翻开空白账册第一页，写下第一个字。",
    ]))
